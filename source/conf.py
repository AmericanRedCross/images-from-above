...
project = u'Images from above'
html_show_copyright = False
copyright = u'2020, IFRC'
author = u'Dan Joseph, Guido Pizzini, Lauri Pynnonen'
...
# -- Options for https://github.com/sphinx-contrib/googleanalytics --------

googleanalytics_id = 'G-02376HP34H'
...
latex_documents = [
    ...
    'Images_from_Above.tex', # targetname
    u'Images from above: A review of aerial assessment in support of humanitarian response operations', # title
    u'Dan Joseph, Guido Pizzini, Lauri Pynnonen', # author
